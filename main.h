...
{
	char c;
	int (*f)(va_list ap, jacs *f);
} ph;

/* print_nums */
int print_int(va_list l, jacs *f);
void print_number(int n);
int print_unsigned(va_list l, jacs *f);
int count_digit(int i);

/* print_bases */
int print_hex(va_list l, jacs *f);
int print_hex_big(va_list l, jacs *f);
int print_binary(va_list l, jacs *f);
int print_octal(va_list l, jacs *f);
...
/* get_print */
int (*get_print(char s))(va_list, jacs *);

/* get_flags */
int get_flags(char s, jacs *f);
...
/* print_address */
int print_address(va_list l, jacs *f);
